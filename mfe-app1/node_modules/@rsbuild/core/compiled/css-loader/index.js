(() => {
  var __webpack_modules__ = {
    ...
    7937: (module, __unused_webpack_exports, __nccwpck_require__) => {
      const replaceValueSymbols = __nccwpck_require__(507);
      const replaceSymbols = __nccwpck_require__(4172);
      const extractICSS = __nccwpck_require__(9578);
      const createICSSRules = __nccwpck_require__(5300);
      module.exports = {
        replaceValueSymbols,
        replaceSymbols,
        extractICSS,
    ...
    4172: (module, __unused_webpack_exports, __nccwpck_require__) => {
      const replaceValueSymbols = __nccwpck_require__(507);
    ...
    4975: (module, __unused_webpack_exports, __nccwpck_require__) => {
      const topologicalSort = __nccwpck_require__(7360);
    ...
    9850: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const selectorParser = __nccwpck_require__(7230);
      const valueParser = __nccwpck_require__(2948);
      const { extractICSS } = __nccwpck_require__(7937);
    ...
    1580: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const selectorParser = __nccwpck_require__(7230);
    ...
    9949: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const ICSSUtils = __nccwpck_require__(7937);
      const matchImports =
        /^(.+?|\([\s\S]+?\))\s+from\s+("[^"]*"|'[^']*'|[\w-]+)$/;
